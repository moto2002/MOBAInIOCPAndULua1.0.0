...
public class DelegateFactoryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("Action_objects", Action_objects),
			new LuaMethod("Action_object", Action_object),
			new LuaMethod("Canvas_WillRenderCanvases", Canvas_WillRenderCanvases),
			new LuaMethod("RectTransform_ReapplyDrivenProperties", RectTransform_ReapplyDrivenProperties),
			new LuaMethod("InputField_OnValidateInput", InputField_OnValidateInput),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int Canvas_WillRenderCanvases(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		LuaFunction arg0 = LuaScriptMgr.GetLuaFunction(L, 1);
		Delegate o = DelegateFactory.Canvas_WillRenderCanvases(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int InputField_OnValidateInput(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		LuaFunction arg0 = LuaScriptMgr.GetLuaFunction(L, 1);
		Delegate o = DelegateFactory.InputField_OnValidateInput(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
